...
const number = +prompt(
  "Данная программа выводит разряды числа, а именно: количество сотен, десятков и единиц.\nВведите целое число: "
);
const hundreads = Math.trunc(number / 100) % 10;
const tens = Math.trunc(number / 10) % 10;
const units = number % 10;

console.log(
  `В числе ${number} количество сотен: ${hundreads}, десятков: ${tens}, единиц: ${units}`
);
